...
func TestActionUnionsRoundTrip(t *testing.T) {
	tests := []struct {
		...
		{"PartialEntity newtype", `{"Server":{"server_id":"1","name":"n","avatar":"a","total_members":0,"online_members":0,"short":"s","type":"t","votes":0,"invite_clicks":0,"clicks":0,"nsfw":false,"discord_nsfw_level":0,"nsfw_channel_count":0,"tags":[],"premium":false,"claimed_by":null,"last_claimed":null,"approval_note":"","mentionable":[],"moderation_flagged":false,"moderation_categories":[]}}`, func() json.Unmarshaler { return &PartialEntity{} }},
	}
